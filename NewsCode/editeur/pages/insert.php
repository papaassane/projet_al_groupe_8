<?php
	...
	if(!empty($_POST))
	{
		...
		//c'est recupérer des fichiers images
...
//            }
		...
		if($isSuccess && $isUploadSuccess)
		{
            ...
            $statement = $db->prepare("INSERT INTO items (name,description,price,category,liens,image) values(?, ?, ?, ?, ?, ?)");
			//exécuter la requête sql
            $statement->execute(array($name,$description,$price,$category,liens,$image));
                    ...
                    <form class="form" role="form"	action="insert.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
						  ...
						  <select class="form-control" id="category" name="category">
							  <?php 
							  	//se connecter à la bade donnée 
							  	$db = Database::connect();
							  	//on crée un foreach pour mettre tout dans le forech
