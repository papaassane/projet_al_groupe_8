<?php
    ...
    $liensError = $nameError = $descriptionError = $priceError = $categoryError = $imageError = $name = $description = $price = $category = $image = $liens = "";
...
//            }
        ...
        { 
            ...
            if($isImageUpdated)
            {
                $statement = $db->prepare("UPDATE items  set name = ?, description = ?, price = ?, category = ?,liens = ?, image = ? WHERE id = ?");
                $statement->execute(array($name,$description,$price,$category,$liens,$image,$id));
            }
            else
            {
                $statement = $db->prepare("UPDATE items  set name = ?, description = ?, price = ?, category = ?,liens = ? WHERE id = ?");
                $statement->execute(array($name,$description,$price,$category,$liens,$id));
            }
            Database::disconnect();
